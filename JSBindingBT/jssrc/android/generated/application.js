...
function appmiddlewareinvoker(inputParam, isBlocking, indicator, datasetID) {
    ...
    inputParam["platformver"] = "6.5.QA_v201506300011_r6";
...
function callAppMenu() {
    ...
    kony.application.createAppMenu("JSBindingBTAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("JSBindingBTAppMenu");
}