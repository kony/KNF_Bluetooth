    ...
    function startscanscan() {
        ...
        if (i == 0) context1.registerReceiver(new Hello1(), new IntentFilter(BluetoothDevice.ACTION_FOUND));
        i = 1;
    }
    ...
    function BondDevice() {
        ...
        if (searchDeviceSelected.getBondState() != BluetoothDevice.BOND_BONDED) searchDeviceSelected.createBond();
